...
This project is designed for showcasing and testing MTI/D2 key exchange algorithm using the `libakrypt` library. It provides functionality to exchange keys between multiple subjects, utilizing MTI/D2 algorithm.
